define(function(require, exports, module) {
    ...
    var FamousEventHandler = require('./customEventHandler');
     ...
     */
    RenderNode.prototype.on = function(type, handler) { 
        eventHandler.on(type, handler, this); 
    };
    RenderNode.prototype.emit = function(type, event) { 
        eventHandler.emit(type, event, this); 
    };
